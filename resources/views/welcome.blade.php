            ...
            <div class="max-w-7xl mx-auto px-6">
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    ...
                    <div class="feature-card p-10 bg-white dark:bg-[#151515] rounded-3xl border border-[#19140008] dark:border-[#ffffff08]">
                        ...
                        <p class="text-[#706f6c] dark:text-[#A1A09A] leading-relaxed">Visualize your occupancy rates and peak hours with easy-to-understand charts.</p>
                    </div>
                    ...
                    <div class="feature-card p-10 bg-white dark:bg-[#151515] rounded-3xl border border-[#19140008] dark:border-[#ffffff08]">
                        ...
                        <p class="text-[#706f6c] dark:text-[#A1A09A] leading-relaxed">Secure logins and restricted access mean your vehicle logs are always protected.</p>
                    </div>
                </div>
            </div>
        </section>
